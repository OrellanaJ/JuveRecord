...
if(isset($_SESSION['u_usuario'])) {
    ...
    <div class="container">
        ...
        <hr>
        <div class="row">
            <?php //aqui se modifico id motoquero asignado a id distribuidor
            $query_pedidos = $pdo->prepare("SELECT * FROM tb_pedidos WHERE id_distribuidor_asignado = '$id_usuario_s' AND estado ='1' ORDER BY id_pedido DESC ");
            ...
            foreach ($pedidos as $pedido) {
                ...
                $id_distribuidor_asignado = $pedido['id_distribuidor_asignado'];
                ...
                if($estado_pedido == "PEDIDO FINALIZADO"){
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"><h4><b>Pedido Nuevo Pedido_N° <?php echo $id_pedidos;?></b></h4></span>
                            ...
                            if($estado_pedido == "PEDIDO TOMADO"){ ?>
                                <span class="info-box-text text-right" style="margin-top: -10px">
                                   <button class="btn btn-danger btn-sm">
                                        <i class="fa fa-check-truck"></i>  PEDIDO TOMADO
                                   </button>
                               </span>
                                <?php
                            }
                           ...
                           <a href="ver_pedido.php?id_p=<?php echo $id_pedidos;?>&&email_m=<?php echo $email;?>" class="btn btn-info btn-sm">
        ...
        <div class="row" style="background: #c0c0c0">
            <?php //aqui se modifico id motoquero asignado a id distribuidor
            $query_pedidos_f = $pdo->prepare("SELECT * FROM tb_pedidos WHERE id_distribuidor_asignado = '$id_usuario_s' AND estado_pedido = 'PEDIDO FINALIZADO' AND estado ='1' ORDER BY id_pedido DESC ");
            ...
            foreach ($pedidos_f as $pedido_f) {
                ...
                $id_distribuidor_asignado = $pedido_f['id_distribuidor_asignado'];
                $estado_pedido = $pedido_f['estado_pedido'];
                ?>
                <div class="info-box" style="background: #c0c0c0">
                    <span class="info-box-icon bg-danger"><i class="fa fa-shopping-cart"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text"><h4><b>Pedido Finalizado Pedido__N°__|<?php echo $id_pedidos;?></b></h4></span>
                        ...
                        <span class="info-box-text text-right">
                           <a href="ver_pedido_finalizado.php?id_p=<?php echo $id_pedidos;?>&&email_m=<?php echo $email;?>" class="btn btn-info btn-sm">
