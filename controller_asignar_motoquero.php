...
//aqui se modifico id motoquero asignado a id distribuidor
$sentencia = $pdo->prepare("UPDATE tb_pedidos SET id_distribuidor_asignado='$id_motoquero', estado_pedido='$estado_pedido' WHERE id_pedido='$id_pedido' ");
