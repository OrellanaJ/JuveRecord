...
foreach ($pedidos as $pedido) {
    ...
    $costo_emvio = $pedido['costo_emvio']; //a costo_emvio se modifico
    $obs = $pedido['obs'];
    $id_carrito = $pedido['id_carrito'];
    $id_distribuidor_asignado = $pedido['id_distribuidor_asignado']; //aqui se modifico id motoquero asignado a id distribuidor
...
<div class="container">
    <div class="">
        ...
        <p>
            ...
            <b>Referencia:</b> <?php echo $celular_referencia_cliente;?> <br>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-xs table-condensed" style="font-size: 12px">
                <th style="background: #00BFFF">N°</th>
                <th style="background: #00BFFF">Producto</th>
                <th style="background: #00BFFF">Detalle</th>
                <th style="background: #00BFFF">Cantidad</th>
                <th style="background: #00BFFF">Precio Unitario</th>
                <th style="background: #00BFFF">Precio Total</th>
                <?php
                ...
                ?>
                <tr>
                    <td colspan="3" align="right" style="background: #00BFFF"><b>Totales</b></td>
                    <td align="right" style="background: #00BFFF"><b><center><?php echo $contador_de_cantidades;?></center></b></td>
                    <td align="right" style="background: #00BFFF"><b><center><?php echo $contador_de_precio_u;?></center></b></td>
                    <td align="right" style="background: #00BFFF"><b><center><?php echo $contador_de_precio_t;?></center></b></td>
                </tr>
            </table>
        </div>
        <br>
        <span>
            ...
            <b style="color: #00558F">Costo de Pedido: <span style="font-size: 25px">Bs. <?php echo $costo_pedido;?></span></b>
        </span>
        <br>
        <span>
            <i class="fa fa-truck" style="color: #00558F"></i>
            <b style="color: #00558F">Costo de Entrega: <span style="font-size: 25px">Bs. <?php echo $costo_emvio;?></span></b>
        </span>
        <hr>
        <span>
            <b style="color: #00558F">Costo Total: <span style="font-size: 25px">Bs. <?php echo $costo_total = $costo_pedido + $costo_emvio;?></span></b>
        </span>
        <br><br>
        <?php
        if($obs == ""){
        ...
        <button
           class="btn btn-danger btn-block btn-lg" disabled="">
            <i class="fa fa-truck"></i> PEDIDO ENTREGADO
        </button>
