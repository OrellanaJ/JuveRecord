...
if($sentencia->execute()){
   ?>
    <table class="table table-sm table-bordered" id="tabla_carrito1">
        <th style="background: rgba(0, 191, 255)"><b><center>N°</center></b></th>
        <th style="background: rgba(0, 191, 255)"><b>Producto</b></th>
        <th style="background: rgba(0, 191, 255)"><b>Detalle</b></th>
        <th style="background: rgba(0, 191, 255)"><b><center>Cantidad</center></b></th>
        <th style="background: rgba(0, 191, 255)"><b><center>Precio Unitario</center></b></th>
        <th style="background: rgba(0, 191, 255)"><b><center>Precio Total</center></b></th>
        <th style="background: rgba(0, 191, 255)"><b><center>Acciones</center></b></th>
        <?php
        $contador_carrito = 0;
        ...
        ?>
        <tr>
            <td style="background: rgba(0, 191, 255)" colspan="3" align="right"><b>Total</b></td>
            <td style="background: rgba(0, 191, 255)"><center><b><?php echo $total_cantidades;?></b></center></td>
            <td style="background: rgba(0, 191, 255)"><center><b><?php echo $total_precio_unitario;?></b></center></td>
            <td style="background: rgba(0, 191, 255)"><center><b><?php echo $total_precio_total;?></b></center></td>
        </tr>
    </table>
<?php
}else{
